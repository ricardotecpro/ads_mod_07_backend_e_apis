...
## A Importância de Infra. Cloud Native 📈
...
## 2. Abordando Kubernetes 📊

```mermaid
graph LR
    User -->|Call| Server[Infra. Cloud Native]
...
## Aprofundando em Service Discovery e Autoscaling 🚢

- **Service Discovery**: <span class="fragment">Reduz o acoplamento temporal. <!-- .element: class="fragment" --></span>
- **Autoscaling**: <span class="fragment">Garante que o estado seja imutável a longo prazo. <!-- .element: class="fragment" --></span>

---

## Resumo e Próximos Passos ✅

- A base de **Infra. Cloud Native** é sólida. <!-- .element: class="fragment" -->
