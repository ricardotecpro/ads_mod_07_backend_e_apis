...
Quando lidamos com *Sec e Autenticação*, a performance pode ser modelada através da Lei de Amdahl:
...
[➡️ Próxima Aula: Persistência e Dados](./aula-06.md){ .md-button .md-button--primary }